...
if saveR:
    ...
    # --- Option 1: Save as .AT2 format ---
        ...
        textfile = hf.my_save_results_as_at2(results, comp_key='ccs', header_details=at2_header_details)
        st.download_button("Save Spectrally Matched Record as .AT2", textfile, file_name=at2_filepath, mime="text/csv",)
